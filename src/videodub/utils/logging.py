...
def setup_pipeline_logging(
    output_directory: Path, level: str = "INFO", enable_json: bool = True
) -> None:
    """
...
def log_pipeline_start(video_id: str, url: str, config: dict) -> None:
    ...
    logger.info("Pipeline started", video_id=video_id, url=url, config=config)


def log_pipeline_end(
    video_id: str, success: bool, duration: float, files: dict
) -> None:
    """
    ...
    if success:
        ...
        logger.error("Pipeline failed", video_id=video_id, duration_seconds=duration)
...
def log_step_start(step_name: str, video_id: str, **kwargs) -> None:
    ...
    logger.info(f"Step started: {step_name}", video_id=video_id, **kwargs)
...
def log_step_end(step_name: str, video_id: str, success: bool, **kwargs) -> None:
    ...
    if success:
        logger.info(f"Step completed: {step_name}", video_id=video_id, **kwargs)
    else:
        logger.error(f"Step failed: {step_name}", video_id=video_id, **kwargs)
